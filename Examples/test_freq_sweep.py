...
start_fft = 1  # [s] Time for the DUT to reach the new steady-state (injections)
fft_periods = 1  # Number of periods used in the FFT for the lowest frequency

t_sim = delay_inj + start_fft + fft_periods / f_base  # [s]
t_step = 0.1  # [us]
# The sampling time is set to half of the minimum required value based on the maximum frequency (multiple of step_time)
...
frequency_sweep.frequency_sweep(t_snap=t_snap, t_sim=t_sim, t_step=t_step, sample_step=sample_step, v_perturb_mag=v_perturb_mag,
