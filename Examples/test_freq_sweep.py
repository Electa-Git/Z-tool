...
frequency_sweep.frequency_sweep(t_snap=t_snap, t_sim=t_sim, t_step=t_step, sample_step=sample_step,
                                v_perturb_mag=v_perturb_mag,
                                f_points=perturbations, f_base=f_base, f_max=f_max, f_min=f_min, delay_inj=delay_inj,
                                start_fft=start_fft, fft_periods=fft_periods, compute_yz=True,
