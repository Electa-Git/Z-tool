                    ...
                    if network.scan_type == "AC":
                        ...
                        if exploit_dq_sym:
                            ...
                            if col < N/2:
                                ...
                                deltaV[sim, 2*block_num+1, 2*col+1] = deltaV[sim, 2*block_num,   2*col]
                                deltaI[sim, 2*block_num,   2*col+1] = - deltaI[sim, 2*block_num+1, 2*col]
                                deltaI[sim, 2*block_num+1, 2*col+1] = deltaI[sim, 2*block_num,   2*col]
