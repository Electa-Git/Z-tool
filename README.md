...
The following features are currently under development:
  1) Current/voltage perturbation
  2) PSCAD library
...
1)	Python 3.7 or higher together with
  a.	Numpy (already included in most python packages such as Anaconda)
  b.	Matplotlib (idem)
  c.	PSCAD automation library: https://www.pscad.com/webhelp-v5-al/index.html
